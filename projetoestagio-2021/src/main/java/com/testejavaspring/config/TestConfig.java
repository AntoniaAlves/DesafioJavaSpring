...
public class TestConfig<asList> implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//OrderItem oi1 = new OrderItem(o1, x, 2000, u1);
		//OrderItem oi2 = new OrderItem(o1, y, 3000, u1);
		//OrderItem oi3 = new OrderItem(o2, x, 1500, u2);
		//OrderItem oi4 = new OrderItem(o3, y, 1500, u2);
		//OrderItem oi5 = new OrderItem(o3, x, 2000, u3);
		//OrderItem oi6 = new OrderItem(o3, y, 2000, u3);
